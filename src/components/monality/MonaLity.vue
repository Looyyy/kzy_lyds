<template>
  <div class="app.container">
   ...
   <van-swipe :autoplay="3000" indicator-color="black">
      <van-swipe-item><img src="../../assets/images/slidepic6.jpg" alt=""></van-swipe-item>
      <van-swipe-item><img src="../../assets/images/slidepic7.jpg" alt=""></van-swipe-item>
      <van-swipe-item><img src="../../assets/images/slidepic8.jpg" alt=""></van-swipe-item>
      <van-swipe-item><img src="../../assets/images/slidepic9.jpg" alt=""></van-swipe-item>
    </van-swipe>
    <!-- 产品描述 -->
    <p class="describe">中国足球队 包邮</p>
    <!-- 价格类 -->
    <div class="price">
      价格：<span class="oldPrice"><b>￥98.33</b></span><span class="nowprice">￥55.98</span>
    </div>
    <div class="specification">
      规格: <span class="weight">三斤装</span><span class="check_box"  @click="showTye"><b><van-icon name="arrow" />
    </b>
      </span>
    </div>
      <van-sku
